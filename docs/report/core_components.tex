...
Not all tasks are driven the same was. Some tasks are purely cooperative: they perform, work, sleep for a number of ticks, and then continue. Examples include periodic demo tasks, dashboards, and visualization. Their timing is based on explicit calls to \texttt{task\_sleep()}. 
